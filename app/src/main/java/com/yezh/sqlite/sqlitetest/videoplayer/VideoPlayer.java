...
/**
 * Created by yezh on 2018/9/28 14:58.
 */
...
//            LogUtil.d("onPrepared ——> STATE_PREPARED");
            ...
            if (continueFromLastPosition) {
                long savedPlayPosition = VideoPlayerUtil.getSavedPlayPosition(mContext, mUrl);
...
//            LogUtil.d("STATE_BUFFERING_PAUSED");
    ...
    private void initTextureView() {
        if (mTextureView == null) {
            mTextureView = new MyTextureView(mContext);
        ...
        new Handler().post(new Runnable() {
            ...
            public void run() {
                ...
                if (mCurrentMode == MODE_TINY_WINDOW) {
                    ...
                    VideoPlayer.this.removeView(mContainer);
                }
                LayoutParams params = new LayoutParams(
                        ViewGroup.LayoutParams.MATCH_PARENT,
                        ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        new Handler().post(new Runnable() {
            ...
            public void run() {
                ...
                FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(
                        (int) (VideoPlayerUtil.getScreenWidth(mContext) * 0.6f),
...
//            LogUtil.d("MODE_NORMAL");
    ...
    public void release() {
        ...
        if (isPlaying() || isBufferingPlaying() || isBufferingPaused() || isPaused()) {
            VideoPlayerUtil.savePlayPosition(mContext, mUrl, getCurrentPosition());
        } else if (isCompleted()) {
            VideoPlayerUtil.savePlayPosition(mContext, mUrl, 0);
        }
        // 退出全屏或小窗口
        if (isFullScreen()) {
            exitFullScreen();
