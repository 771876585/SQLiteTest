package com.yezh.sqlite.sqlitetest.myvideoplayer;
...
import com.yezh.sqlite.sqlitetest.myvideoplayer.example.adapter.CatalogueAdapter;
...
public class TxVideoPlayerController
    ...
    @Override
    public void setCatalogueList(List<String> catalogueList) {
