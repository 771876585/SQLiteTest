 ...
 * 仿腾讯视频热点列表页播放器控制器.
 */
public class MyVideoPlayerController
    ...
    public void setLenght(long length) {
        mLength.setText(VideoPlayerUtil.formatTime(length));
    }
    ...
    protected void updateProgress() {
        ...
        long bufferPercentage = mVideoPlayer.getBufferPercentage();
        mSeek.setSecondaryProgress((int)bufferPercentage);
    ...
    protected void showChangePosition(long duration, int newPositionProgress) {
        ...
        mChangePositionCurrent.setText(VideoPlayerUtil.formatTime(newPosition));
        mChangePositionProgress.setProgress(newPositionProgress);
        mSeek.setProgress(newPositionProgress);
        mPosition.setText(VideoPlayerUtil.formatTime(newPosition));
    }
