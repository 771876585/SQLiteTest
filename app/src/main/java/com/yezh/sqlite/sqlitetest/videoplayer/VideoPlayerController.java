...
/**
 * Created by yezh on 2018/9/28 15:05.
 */
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!mNeedChangePosition && !mNeedChangeVolume && !mNeedChangeBrightness) {
                    ...
                    if (absDeltaX >= THRESHOLD) {
                        ...
                        if (mDownX < getWidth() * 0.5f) {
                            ...
                            mGestureDownBrightness = VideoPlayerUtil.scanForActivity(mContext)
                                    .getWindow().getAttributes().screenBrightness;
                        } else {
                            // 右侧改变声音
                            mNeedChangeVolume = true;
                            mGestureDownVolume = mVideoPlayer.getVoice();
                        }
                    }
                }
                ...
                if (mNeedChangeBrightness) {
                    ...
                    WindowManager.LayoutParams params = VideoPlayerUtil.scanForActivity(mContext)
